...
class SecureController {
    ...
    def index() {
        ...
        /*def userArrayList = User.findAllByUsername(name)
        def userData = userArrayList.get(0)
    ...
    def list(){
        redirect action: "superAdminPage", params:params
    }
    ...
    /*def superAdminPage(){
        ...
        render (view: 'superAdmin', model:[username: name, companyData: companyList])
    }*/
