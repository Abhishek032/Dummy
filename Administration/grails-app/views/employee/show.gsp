...
<div class="col-md-12">
    ...
    <div class="col-md-12" style="background-color: #f28c38; color: white "><h1 style="text-align:left;font-size:20px;font-family:Verdana ">Employee Information</h1></div>
    <div>
    ...
    <div class="col-sm-12" style="padding: 0 0 0 0; background-color: #f28c38">
        ...
        <div class="col-sm-1" style="border:1px solid white; padding: 10px"><a href="/secure/superAdmin?sort=registrationNo&max=4&order=asc" style="color: #f2f2f2; text-decoration: none">Employee Id</a></div>
        ...
        <div class="col-sm-1" style="border:1px solid white; padding: 10px"><a href="/secure/superAdmin?sort=email&max=4&order=asc" style="color: #f2f2f2; text-decoration: none">Role</a></div>
        <div class="col-sm-2" style="border:1px solid white; padding: 10px"><a href="/secure/superAdmin?sort=email&max=4&order=asc" style="color: #f2f2f2; text-decoration: none">Company Name</a></div>
    </div>
    <g:each in="${company}" var="comp" status="i">
        <g:each in="${comp.employee}" var="employee" status="j">
            <div class="col-sm-12" style="background-color: #f2f2f2; padding: 5px 0 5px 0; border:1px solid white">

                <div class="col-sm-2" style="padding: 0 0 0 5px;">${employee.firstName}</div>
                <div class="col-sm-2" style="padding: 0 0 0 5px;">${employee.middleName}</div>
                <div class="col-sm-2" style="padding: 0 0 0 5px;">${employee.lastName}</div>
                <div class="col-sm-1" style="padding: 0 0 0 5px;">${employee.id}</div>
                <div class="col-sm-2" style="padding: 0 0 0 5px;">${employee.location}</div>
                <div class="col-sm-1" style="padding: 0 0 0 5px;">${employee.employeeRole}</div>
                <div class="col-sm-2" style="padding: 0 0 0 5px;">${comp.getCompanyName()}</div>
            </div>
        </g:each>
    </g:each>
</div>
