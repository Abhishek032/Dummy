...
<div align="center">
    <h2 style="margin-top: 5px;margin-bottom: 5px"><%=company.getCompanyName()%></h2>
    <hr>
    <table border="0">
        <tr>
    ...
    <%if(module!=null){
        for(com.grails.Module mod : module.sort{it.id}){%>
            <input type="submit" name="module" value="${mod.getModuleName()}" style="border: none; text-shadow: none;  width: 8%; padding:2px; margin-bottom: 3px; margin-top: 3px; color:#204060; background-color: white; box-shadow:none"><br>
    <%}}%>
    </g:form>
    <hr>

    <g:link controller="admin" action="employeePage" style="color: #2b406e; text-decoration: none"><b>Employee</b></g:link>
