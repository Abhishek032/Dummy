...
<div>
    <div class="col-sm-2" style="height:572px; background-color:lavender;" align="center">
        ...
        --}%
%{--<g:form controller="company" action="createEmployee">
            <input type="hidden" name="index" value="<%=company.getId()%>">
            <button type="submit"style="background-color:lavender;color: #2b406e;border: 0px">Create Employee</button>
        </g:form>--}%%{--
...
<div class="col-md-12">
    ...
    <div class="col-md-12" style="background-color: #f28c38; color: white "><h1 style="text-align:left;font-size:20px;font-family:Verdana ">${company.companyName} Employee's Information</h1></div>
    <div>
    ...
    <g:each in="${company.employee}" var="employee" status="i">
        <div class="col-sm-12" style="background-color: #f2f2f2; padding: 5px 0 5px 0; border:1px solid white">

            <div class="col-sm-2" style="padding: 0 0 0 0;"><div class="col-sm-2">${employee.firstName}</div></div>
            <div class="col-sm-2" style="padding: 0 0 0 0;"><div class="col-sm-2">${employee.middleName}</div></div>
            <div class="col-sm-2" style="padding: 0 0 0 0;"><div class="col-sm-2">${employee.lastName}</div></div>
            <div class="col-sm-2" style="padding: 0 0 0 0;"><div class="col-sm-2">${employee.id}</div></div>
            <div class="col-sm-2" style="padding: 0 0 0 0;"><div class="col-sm-2">${employee.location}</div></div>
            <div class="col-sm-2" style="padding: 0 0 0 0;"><div class="col-sm-2">${employee.employeeRole}</div></div>
        </div>
    </g:each>
</div>
</body>
