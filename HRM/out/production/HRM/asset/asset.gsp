...
<div class="col-md-12">
    ...
    <div class="col-sm-12" style="padding: 0 0 0 0; background-color: #f28c38">
        <div class="col-sm-2" style="border:1px solid white; padding: 10px;color: #f2f2f2; text-decoration: none"><a href="/secure/superAdmin?sort=companyName&max=4&order=asc">Name</a></div>
        <div class="col-sm-2" style="border:1px solid white; padding: 10px;color: #f2f2f2; text-decoration: none"><a href="/secure/superAdmin?sort=companyName&max=4&order=asc">Type</a></div>
        <div class="col-sm-2" style="border:1px solid white; padding: 10px;color: #f2f2f2; text-decoration: none"><a href="/secure/superAdmin?sort=companyName&max=4&order=asc">Serial No.</a></div>
        <div class="col-sm-2" style="border:1px solid white; padding: 10px;color: #f2f2f2; text-decoration: none"><a href="/secure/superAdmin?sort=companyName&max=4&order=asc">Product ID</a></div>
        <div class="col-sm-2" style="border:1px solid white; padding: 10px;color: #f2f2f2; text-decoration: none"><a href="/secure/superAdmin?sort=companyName&max=4&order=asc">Issued To</a></div>
        <div class="col-sm-2" style="border:1px solid white; padding: 10px;color: #f2f2f2; text-decoration: none"><a href="/secure/superAdmin?sort=companyName&max=4&order=asc">Issue Date</a></div>
    </div>
