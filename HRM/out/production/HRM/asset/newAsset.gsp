        ...
        <div class="inner" style="font-size:20px;height: auto">
            <g:form name="assetForm" url="[controller:'asset', action:'saveAsset']">
                ...
                <div class="col-md-12" style="padding: 10px 0 10px 0" >
                    ...
                    <button class="btn btn-success" type="button" style="margin-left:30px; font-size:30px; padding: 0 12px 0 12px; border-radius: 100px" onclick="act()">+</button><br>
                </div>
                <hr style="padding: 5px;margin: 0px">
                <input type="hidden" id="index" name="index" value="">
                <div class="col-sm-10"><input type="submit" class="btn btn-success" name="submit" value="Save"></div>
