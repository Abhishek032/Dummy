...
<head>
    ...
    <title>HRM | ${companyName} | Edit Holiday</title>
</head>
<body>
<div class="col-md-12">
    ...
    <div class="col-md-12" style="background-color: #f28c38; color: white ">
        <h1 style="text-align:left;font-size:20px;font-family:Verdana ">${companyName} | Edit Holiday : ${holidayList.getAt(0).year}</h1></div>
    <div>
    ...
    <div class="box, col-md-12" style="border-radius:5px; background-color: #f7f6f6; padding-top: 15px; padding-bottom: 15px">
        <div class="inner" style="font-size:20px;height: auto">
            <g:form name="holidayForm" url="[controller:'holiday', action:'updateHoliday']">
                <input type="hidden" name="year" value="${holidayList.getAt(0).year}">
                <fieldset>Edit Holiday</fieldset>
                <hr>
                <div class="col-md-12" style="padding: 10px 0 10px 0" >
                    <g:each in="${holidayList.sort{it.holidayDate}}" var="holiday" status="i">
                        <div class="col-md-12" id="date${i}" >
                            <div class="col-md-4" style="padding: 5px" >
                                ...
                                <div class="col-md-8" style="padding-left: 0px; padding-right: 0px">
                                    <input class="inputStyle" type="date" name="holidayDate${i}" value="${holiday.holidayDate}">
                                </div>
                            </div>
                            <div class="col-md-4" style="padding: 5px">
                                <div class="col-md-4" style="padding-left: 0px; padding-right: 0px;font-family:verdana;font-size:12px;" >
                                ...
                                <div class="col-md-8" style="padding-left: 0px; padding-right: 0px">
                                    <input class="inputStyle" type="text" name="title${i}" value="${holiday.title}">
                                </div>
                            </div>
                        </div>
                    </g:each>
                ...
                <input type="hidden" name="index" value="${holidayList.size()}">
