...
/*package*/ final class AchievementJSONImpl extends FacebookResponseImpl implements Achievement, java.io.Serializable {
    ...
    private AchievedObject achievement;
    ...
    private void init(JSONObject json) throws FacebookException {
        try {
            ...
            if (!json.isNull("achievement")) {
                achievement = new AchievedObjectJSONImpl(json.getJSONObject("achievement"));
            }
    ...
    public AchievedObject getAchievement() {
        return achievement;
    }
    ...
    private final class AchievedObjectJSONImpl implements AchievedObject, java.io.Serializable {
