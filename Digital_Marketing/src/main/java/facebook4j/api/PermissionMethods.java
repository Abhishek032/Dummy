...
public interface PermissionMethods {
    ...
    /**
     * This method is an alias of: {@link PermissionMethods#revokeAllPermissions()} .
     * @return true if revoke is succressful
     * @throws FacebookException when Facebook service or network is unavailable
     * @see <a href="https://developers.facebook.com/docs/reference/api/user/#permissions">User#permissions - Facebook Developers</a>
     */
    ...
    /**
     * This method is an alias of: {@link PermissionMethods#revokePermission(String)} .
     * @param permissionName permission name
     * @return true if revoke is succressful
     * @throws FacebookException when Facebook service or network is unavailable
     * @see <a href="https://developers.facebook.com/docs/reference/api/user/#permissions">User#permissions - Facebook Developers</a>
    ...
    /**
     * This method is an alias of: {@link PermissionMethods#revokePermission(String, String)} .
     * @param userId the ID of a user
     * @param permissionName permission name
     * @return true if revoke is succressful
     * @throws FacebookException when Facebook service or network is unavailable
